...
INSERT INTO public.contract_definitions VALUES ('ml_contract_002', 'ID_POLICY_001', 'ID_POLICY_001', '[{"operator": "in", "operandLeft": "https://w3id.org/edc/v0.0.1/ns/id", "operandRight": ["ML_Model_002"]}]', '2025-12-11 15:03:32.647688', '2025-12-11 15:03:32.647688', 'user-conn-oeg-demo');
INSERT INTO public.contract_definitions VALUES ('ml_contract_with_constraints', 'ID_POLICY_WITH_CONSTRAINTS', 'ID_POLICY_WITH_CONSTRAINTS', '[{"operator": "in", "operandLeft": "https://w3id.org/edc/v0.0.1/ns/id", "operandRight": ["ML_Model_001", "ML_Model_002"]}]', '2025-12-11 15:30:41.793738', '2025-12-11 15:30:41.793738', 'user-conn-oeg-demo');
INSERT INTO public.contract_definitions VALUES ('contract_006', 'time_policy', 'time_policy', '[{"operator": "in", "operandLeft": "https://w3id.org/edc/v0.0.1/ns/id", "operandRight": ["ML_model_004"]}]', '2025-12-12 00:32:56.458552', '2025-12-12 00:32:56.458552', 'user-conn-oeg-demo');
INSERT INTO public.contract_definitions VALUES ('contract-iris-http-1765535248', 'policy-iris-http-1765535248', 'policy-iris-http-1765535248', '[{"operator": "=", "operandLeft": "id", "operandRight": "iris-http-1765535248"}]', '2025-12-12 10:27:28.507182', '2025-12-12 10:27:28.507182', 'user-conn-oeg-demo');
INSERT INTO public.contract_definitions VALUES ('contract-iris-http-1765537190', 'policy-iris-http-1765537190', 'policy-iris-http-1765537190', '[{"operator": "=", "operandLeft": "id", "operandRight": "iris-http-1765537190"}]', '2025-12-12 10:59:50.807482', '2025-12-12 10:59:50.807482', 'user-conn-oeg-demo');
INSERT INTO public.contract_definitions VALUES ('contract_001_ml', 'policy_002_ld', 'policy_002_ld', '[{"operator": "in", "operandLeft": "https://w3id.org/edc/v0.0.1/ns/id", "operandRight": ["ml_model_010"]}]', '2025-12-12 13:02:15.527779', '2025-12-12 13:02:15.527779', 'user-conn-oeg-demo');
...
INSERT INTO public.policy_definitions VALUES ('ID_POLICY_001', '{"@id": "ID_POLICY_001", "policy": {"@id": "ID_POLICY_001", "@type": "PolicyDefinition", "@context": ["https://www.w3.org/ns/odrl.jsonld", {"edc": "https://w3id.org/edc/v0.0.1/ns/"}], "odrl:permission": [{"odrl:action": "USE"}]}, "@context": {"odrl": "http://www.w3.org/ns/odrl/2/", "@vocab": "https://w3id.org/edc/v0.0.1/ns/"}}', '2025-12-11 15:02:43.571703', '2025-12-11 15:02:43.571703', 'user-conn-oeg-demo');
INSERT INTO public.policy_definitions VALUES ('TIME_RESTRICTED_POLICY', '{"@id": "TIME_RESTRICTED_POLICY", "policy": {"@id": "TIME_RESTRICTED_POLICY", "@type": "PolicyDefinition", "@context": ["https://www.w3.org/ns/odrl.jsonld", {"edc": "https://w3id.org/edc/v0.0.1/ns/"}], "odrl:permission": [{"odrl:action": "USE", "odrl:constraint": [{"odrl:operator": "GEQ", "odrl:leftOperand": "POLICY_EVALUATION_TIME", "odrl:rightOperand": "2025-01-01T00:00:00.000Z"}, {"odrl:operator": "LEQ", "odrl:leftOperand": "POLICY_EVALUATION_TIME", "odrl:rightOperand": "2025-12-31T23:59:59.999Z"}]}]}, "@context": {"edc": "https://w3id.org/edc/v0.0.1/ns/"}}', '2025-12-11 15:35:31.274558', '2025-12-11 15:35:31.274558', 'user-conn-oeg-demo');
INSERT INTO public.policy_definitions VALUES ('ID_POLICY_WITH_CONSTRAINTS', '{"@id": "ID_POLICY_WITH_CONSTRAINTS", "policy": {"@id": "ID_POLICY_WITH_CONSTRAINTS", "@type": "PolicyDefinition", "@context": ["https://www.w3.org/ns/odrl.jsonld", {"edc": "https://w3id.org/edc/v0.0.1/ns/"}], "odrl:permission": [{"odrl:action": "USE", "odrl:constraint": [{"odrl:operator": "EQ", "odrl:leftOperand": "DataspaceIdentifier", "odrl:rightOperand": "DataSpacePrototype"}, {"odrl:operator": "EQ", "odrl:leftOperand": "PURPOSE", "odrl:rightOperand": "Research"}]}]}, "@context": {"edc": "https://w3id.org/edc/v0.0.1/ns/"}}', '2025-12-11 15:30:28.260211', '2025-12-11 15:44:46.887529', 'user-conn-oeg-demo');
INSERT INTO public.policy_definitions VALUES ('test-policy-001', '{"@type": "odrl:Set", "odrl:permission": [{"odrl:action": "USE", "odrl:constraint": []}]}', '2025-12-12 00:23:48.464927', '2025-12-12 00:23:48.464927', 'user-conn-oeg-demo');
INSERT INTO public.policy_definitions VALUES ('test-policy-002', '{"@type": "odrl:Set", "odrl:permission": [{"odrl:action": "USE"}]}', '2025-12-12 00:23:58.419871', '2025-12-12 00:23:58.419871', 'user-conn-oeg-demo');
INSERT INTO public.policy_definitions VALUES ('time_policy', '{"@id": "time_policy", "@type": "PolicyDefinition", "@context": ["https://www.w3.org/ns/odrl.jsonld", {"edc": "https://w3id.org/edc/v0.0.1/ns/"}], "odrl:permission": [{"odrl:action": "USE", "odrl:constraint": [{"odrl:operator": "GT", "odrl:leftOperand": "POLICY_EVALUATION_TIME", "odrl:rightOperand": "2025-12-15T23:00:00.000Z"}, {"odrl:operator": "LEQ", "odrl:leftOperand": "POLICY_EVALUATION_TIME", "odrl:rightOperand": "2026-03-24T23:00:00.000Z"}]}]}', '2025-12-12 00:31:17.142866', '2025-12-12 00:31:17.142866', 'user-conn-oeg-demo');
INSERT INTO public.policy_definitions VALUES ('policy-iris-http-1765535248', '{"@type": "odrl:Set", "odrl:permission": [{"odrl:action": "USE"}]}', '2025-12-12 10:27:28.476492', '2025-12-12 10:27:28.476492', 'user-conn-oeg-demo');
INSERT INTO public.policy_definitions VALUES ('policy-iris-http-1765537190', '{"@type": "odrl:Set", "odrl:permission": [{"odrl:action": "USE"}]}', '2025-12-12 10:59:50.779035', '2025-12-12 10:59:50.779035', 'user-conn-oeg-demo');
INSERT INTO public.policy_definitions VALUES ('policy_002_ld', '{"@id": "policy_002_ld", "@type": "PolicyDefinition", "@context": ["https://www.w3.org/ns/odrl.jsonld", {"edc": "https://w3id.org/edc/v0.0.1/ns/"}], "odrl:permission": [{"odrl:action": "USE", "odrl:constraint": [{"odrl:operator": "GEQ", "odrl:leftOperand": "POLICY_EVALUATION_TIME", "odrl:rightOperand": "2025-12-15T23:00:00.000Z"}, {"odrl:operator": "LEQ", "odrl:leftOperand": "POLICY_EVALUATION_TIME", "odrl:rightOperand": "2026-05-30T22:00:00.000Z"}]}]}', '2025-12-12 13:02:09.067957', '2025-12-12 13:02:09.067957', 'user-conn-oeg-demo');
...
INSERT INTO public.users VALUES (3, 'user-conn-oeg-demo', '$2a$10$aHQt0HNWrrCd4cRby26RKudAnanWNx9ZknsaJirTWJF1MMV20Z/gq', 'conn-oeg-demo', 'OEG Demo User', 'demo@oeg.fi.upm.es', true, '2025-12-12 16:41:21.765511', '2025-12-12 16:41:21.765511');
INSERT INTO public.users VALUES (4, 'user-conn-edmundo-demo', '$2a$10$UofjPeL7Zy0295THvlrHlO5H/wOVp7.5U5DYeNniWJzRv2fKH0ph6', 'conn-edmundo-demo', 'Edmundo Demo User', 'edmundo@demo.com', true, '2025-12-12 16:41:21.765511', '2025-12-12 16:41:21.765511');
