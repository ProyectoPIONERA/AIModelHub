...
class InesdataConfig:
    ...
    def public_portal_dir(cls):
        return os.path.join(cls.repo_dir(), "dataspace", "public-portal")

    @classmethod
    def public_portal_values_file(cls):
        return os.path.join(cls.public_portal_dir(), f"values-{cls.dataspace_name()}.yaml")

    @classmethod
    def helm_release_pp(cls):
